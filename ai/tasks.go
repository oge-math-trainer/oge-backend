...
func sdamgiaSpec(target tasks.Target) sdamgiaTaskSpec {
	...
	case 12:
		...
		case "linear_eq_practical":
			spec.SubtypeInstruction = `Дай линейное уравнение в практическом контексте. correct_answer должен быть числом. Пример: 
			'Фирма Родник: C = 6000 + 4100·n, где n — число колец. Найдите стоимость колодца из 5 колец.';
