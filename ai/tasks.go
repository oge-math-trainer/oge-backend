...
func sdamgiaSpec(target tasks.Target) sdamgiaTaskSpec {
	...
	case 13:
		...
		switch subtype {
		case "ineq_linear":
			spec.SubtypeInstruction = `Решение неравенства первой степени и выбор верного варианта. НЕ РИСУЙ КООРДИНАТНЫЕ ПРЯМЫЕ. Дай 4 варианта ответа с промежутками. correct_answer - номер правильного варианта одной цифрой. Пример:
		...
		case "ineq_system":
			spec.SubtypeInstruction = `Решение систем линейных и квадратных неравенств. системы уравнений ОБЯЗАТЕЛЬНО записывай через \\begin{cases} \\\\ \\end{cases} . Дай 4 варианта ответа с промежутками. correct_answer - номер правильного варианта одной цифрой.
			НИКАКИХ КООРДИНАТНЫХ ПРЯМЫХ. варианты ответов записывай текстом. Пример:
			'Решите систему неравенств \\begin{cases} 2x - 3 \\le 5, \\\\ 7 - 3x \\le 1 \\end{cases}\\n1)(-∞; 2]\\n2)(-∞; 2] U [4; +∞)\\n3)[2; 4]\\n4)[2; +∞)'`
		}
