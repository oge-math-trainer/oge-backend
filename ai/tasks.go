...
func sdamgiaSpec(target tasks.Target) sdamgiaTaskSpec {
    ...
    case "simple_inequalities":
        // Неравенства: дано множество на прямой, выбрать число из него
        spec.SubtypeInstruction = "Дай множество чисел на числовой прямой в виде неравенства (например -1 ≤ x < 3). Спроси, какое из предложенных чисел принадлежит этому множеству. Дай 4 варианта ответа числами. correct_answer должен быть одним из этих чисел."
        
    case "compare_numbers":
        // Сравнение чисел: БЕЗ числовой прямой!
        spec.SubtypeInstruction = "Дай задачу на сравнение чисел или определение промежутка. Форматы: 'Какое число заключено между 1/6 и 1/3?' или 'Какому промежутку принадлежит √53?'. Дай ровно 4 варианта ответа. correct_answer должен быть номером варианта (1, 2, 3 или 4). НЕ используй числовую прямую в visual_data для этого подтипа."
        
    case "number_line":
        // Числа на прямой: ЕСТЬ числовая прямая с точками A,B,C,D
        spec.SubtypeInstruction = "Дай числовую прямую с отмеченными точками A, B, C, D. Спроси, какая точка соответствует заданному числу (например √72, π, -2.5). Дай 4 варианта ответа: 1)A 2)B 3)C 4)D. correct_answer должен быть номером варианта (1, 2, 3 или 4). visual_data должен содержать type:'number_line' с точками и их метками."
    }
	case 8:
	...
	case 11:
    	...
    	case "func_graph_match":
        	// Функции и графики: 3 функции, 3 графика
        ...
        // Графики и формулы: 3 графика, 3 формулы
